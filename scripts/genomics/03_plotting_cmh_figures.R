...
adapted_O <-
  GetManhattanPlot(
    ...
    title = expression(paste("O"["1-10"], " generation 20 vs. O"["1-10"], " generation 01")),
    x_label = FALSE,
    y_label = " ",
    palette = "blue",
...
adapted_OBO <-
  GetManhattanPlot(
    ...
    percentage_significance = TRUE,
    title = expression(paste("OBO"["1-5"], " generation 20 vs. OBO"["1-5"], " generation 01")),
    x_label = FALSE,
...
adapted_OB <-
  GetManhattanPlot(
    ...
    percentage_significance = TRUE,
    title = expression(paste("OB"["1-5"], " generation 20 vs. OB"["1-5"], " generation 01")),
    x_label = TRUE,
    y_label = " ",
    palette = "blue",
    y_limit_up = y_limit_up,
...
adapted_B <-
  GetManhattanPlot(
    ...
    percentage_significance = TRUE,
    title = expression(paste("B"["1-10"], " generation 56 vs. B"["1-10"], " generation 01")),
    x_label = FALSE,
    y_label = " ",
    palette = "red",
    y_limit_up = y_limit_up,
...
adapted_nBO <-
  GetManhattanPlot(
    ...
    percentage_significance = TRUE,
    title = expression(paste("nBO"["1-5"], " generation 56 vs. nBO"["1-5"], " generation 01")),
    x_label = FALSE,
    y_label = expression(paste("-log"["10"], "(FDR-adjusted p-value)")),
    palette = "red",
    y_limit_up = y_limit_up,
...
adapted_nB <-
  GetManhattanPlot(
    ...
    percentage_significance = TRUE,
    title = expression(paste("nB"["1-5"], " generation 56 vs. nB"["1-5"], " generation 01")),
    x_label = TRUE,
    y_label = " ",
    palette = "red",
    y_limit_up = y_limit_up,
