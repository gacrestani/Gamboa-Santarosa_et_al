...
input_df <- read_excel("data/phenomics_data/Development Time Gen 14.xlsx", skip = 1, col_types = "text", na = "NA")

time <- read_excel("data/phenomics_data/Development Time Gen 14.xlsx")[1,]
hours <- colnames(time)
