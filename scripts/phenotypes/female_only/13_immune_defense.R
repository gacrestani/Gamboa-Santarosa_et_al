...
custom_colors <- c(
  ...
  "B-type_Control"   = "#e43a3f",  # light red
  "B-type_Infected"  = "#e43a3f"   # dark red
)
...
full_df_female <- full_df[which(full_df$Sex == "F"),]


immune_defense_boxplots <- ggplot(full_df_female, aes(x = Regimen, y = death_percentage, fill = Group)) +
