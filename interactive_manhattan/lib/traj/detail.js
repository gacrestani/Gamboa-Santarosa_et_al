...
(function () {
  ...
  function show(key) {
    ...
    var stats = [];
    if (rec.oo != null) stats.push("O vs O p = " + rec.oo);
    if (rec.ob != null) stats.push("O vs B p = " + rec.ob);
    if (rec.bb != null) stats.push("B vs B p = " + rec.bb);
    if (rec.ad != null) stats.push("adapted (O vs O) p = " + rec.ad);
